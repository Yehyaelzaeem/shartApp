class ProviderOrderModel {
  ...
  int? code;
  String? message;
  List<ProviderOrderModelData>? data;

  ProviderOrderModel({this.success, this.code, this.message, this.data});

  ProviderOrderModel.fromJson(Map<String, dynamic> json) {
    success = json['success'];
    code = json['code'];
    message = json['message'];
    if (json['data'] != null) {
      data = <ProviderOrderModelData>[];
      json['data'].forEach((v) {
        data!.add(new ProviderOrderModelData.fromJson(v));
      });
    }
  }
...
class ProviderOrderModelData {
  ...
  List<ItemsProvider>? items;
  UserAddress? userAddress;

  ProviderOrderModelData(
      {this.id,
        this.providerId,
        this.provider,
        this.userId,
  ...
  ProviderOrderModelData.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    ...
    if (json['items'] != null) {
      ...
      json['items'].forEach((v) {
        items!.add(new ItemsProvider.fromJson(v));
      });
    }
...
class Car {
  ...
  Car.fromJson(Map<String, dynamic> json) {
    ...
    modal = json['modal'] != null ? new City.fromJson(json['modal']) : null;
...
class ItemsProvider {
  ...
  ItemsProvider.fromJson(Map<String, dynamic> json) {
    id = json['id'];
...
class ProviderProduct {
  ...
  ProviderProduct.fromJson(Map<String, dynamic> json) {
    ...
    width = json['width'] != null ? new City.fromJson(json['width']) : null;
    heightId = json['height_id'];
    height = json['height'] != null ? new City.fromJson(json['height']) : null;
    sizeId = json['size_id'];
    size = json['size'] != null ? new City.fromJson(json['size']) : null;
  }
