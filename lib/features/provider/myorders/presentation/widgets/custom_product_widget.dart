...
class CustomProductWidgetOrderProvider extends StatelessWidget {
 final ItemsProvider items;
 final String status;
  const CustomProductWidgetOrderProvider({super.key, required this.items, required this.status});
  @override
