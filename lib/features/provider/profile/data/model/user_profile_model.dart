class ProviderGetProfileModel {
  ...
  int? code;
  String? message;
  ProviderGetProfileModelData? data;

  ProviderGetProfileModel({this.success, this.code, this.message, this.data});

  ProviderGetProfileModel.fromJson(Map<String, dynamic> json) {
    success = json['success'];
    code = json['code'];
    message = json['message'];
    data = json['data'] != null ? new ProviderGetProfileModelData.fromJson(json['data']) : null;
  }
