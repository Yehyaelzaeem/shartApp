...
class CustomPreviousOrderHomeWidget extends StatelessWidget {
  const CustomPreviousOrderHomeWidget({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return BlocConsumer<ProviderOrdersCubit, ProviderOrdersState>(
      ...
      builder: (BuildContext context,ProviderOrdersState state) {
         if(cubit.myOrdersPrevious!=null){
           if(cubit.myOrdersPrevious!.data!.length==0){
             return Padding(
             ...
             return ListView.builder(
                 ...
                 return InkWell(
                   onTap: () {
                     Navigator.push(context, MaterialPageRoute(builder:
                         (BuildContext context)=>OrderDetailsProviderScreen(providerOrderModelData: cubit.myOrdersPrevious!.data![index],)));
                   },
               ...
               itemCount: cubit.myOrdersPrevious!.data!.length,
             );
           }
         }else{
           return Padding(
