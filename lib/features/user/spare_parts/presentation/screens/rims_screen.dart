...
class RimsScreen extends StatefulWidget {
  const RimsScreen({Key? key}) : super(key: key);

  @override
  State<RimsScreen> createState() => _RimsScreenState();
}

class _RimsScreenState extends State<RimsScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: PreferredSize(
          child: CustomAppBar(title: 'الجنوط',hasBackButton: true),
              ...
              children: <Widget>[
                ...
                Container(
                  ...
                  child: IconButton(
                    ...
                    onPressed: () {
                      NavigationManager.push(Routes.filterTiresAndRims);
