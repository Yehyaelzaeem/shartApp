                ...
                Column(
                  ...
                  <Widget>[
                    Container(
                      ...
                      child: Center(
                          child: Text('${cubit.packageCheckModel!.data![index!].title}',
                            style: TextStyle(
                              fontSize: 24.sp,
                        ...
                        return Container(
                          ...
                          child: Row(
                            children: <Widget>[
                              ...
                              SizedBox(width: 8.w),
                              Text('${cubit.packageCheckModel!.data![index!].features![i]}')
                            ],
                          ),
                        );
                      },
                      shrinkWrap: true,
                      itemCount: cubit.packageCheckModel!.data![index!].features!.length,
                    ),
                    Spacer(),
                    Padding(
                    ...
                    child: Center(
                      child: CircleAvatar(
                        ...
                        child: CircleAvatar(
                          ...
                          child: Text(
                            '${cubit.packageCheckModel!.data![index!].price}\n ${getLang(context, 'rs')}',
                            style: TextStyle(
                              fontSize: 20.sp,
                              fontWeight: FontWeightManager.bold,
                              fontFamily: FontConstants.lateefFont,
