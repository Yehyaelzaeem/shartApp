class UserProductModel {
  ...
  UserProductModel({this.success, this.code, this.message, this.data});
...
class ProductModelData {
  ...
  ProductModelData.fromJson(Map<String, dynamic> json) {
    ...
    provider = json['provider'] != null
        ? new ProductModelProvider.fromJson(json['provider'])
        : null;
...
class ProductModelProvider {
  ...
  ProductModelProvider.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    name = json['name'];
    email = json['email'];
    phone = json['phone'];
