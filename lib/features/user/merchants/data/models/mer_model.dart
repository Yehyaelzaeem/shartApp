class MerchantsModel {
  ...
  int? code;
  String? message;
  List<MerchantsModelData>? data;

  MerchantsModel({this.success, this.code, this.message, this.data});
  ...
  MerchantsModel.fromJson(Map<String, dynamic> json) {
    ...
    if (json['data'] != null) {
      data = <MerchantsModelData>[];
      json['data'].forEach((v) {
        data!.add(new MerchantsModelData.fromJson(v));
      });
    }
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.data != null) {
      data['data'] = this.data!.map((MerchantsModelData v) => v.toJson()).toList();
    }
    return data;
  }
}

class MerchantsModelData {
  int? id;
  String? name;
  String? email;
  String? phone;
  ...
  MerchantsModelData.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    name = json['name'];
    email = json['email'];
    phone = json['phone'];
