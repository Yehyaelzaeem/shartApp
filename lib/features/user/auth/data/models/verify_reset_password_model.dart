class VerifyResetPasswordModel {
  ...
  int? code;
  String? message;
  VerifyResetPasswordModelData? data;

  VerifyResetPasswordModel({this.success, this.code, this.message, this.data});

  VerifyResetPasswordModel.fromJson(Map<String, dynamic> json) {
    success = json['success'];
    code = json['code'];
    message = json['message'];
    data = json['data'] != null ? new VerifyResetPasswordModelData.fromJson(json['data']) : null;
  }
...
class VerifyResetPasswordModelData {
  int? id;
  String? name;
  String? email;
  String? phone;
  ...
  VerifyResetPasswordModelData.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    name = json['name'];
    email = json['email'];
    phone = json['phone'];
